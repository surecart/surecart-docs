...
Need to customize the HTML output of checkout blocks? You can modify any SureCart block's rendered HTML using WordPress's `render_block` filter and the HTML Tag Processor.
