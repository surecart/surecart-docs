...
Add custom fields, checkboxes, or content to checkout forms using the `render_block` filter. This guide walks you through adding a terms checkbox with server-side validation.
...
See [Checkout validation](/documentation/actions-filters/checkout#form-validation) for more validation examples.
</Step>
</Steps>
